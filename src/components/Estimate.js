...
const EstimateForm = () => {
  ...
  const jwtToken = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiI5MjA5MTYwNjEyIiwiaWF0IjoxNzQ0NDM2NDMwLCJleHAiOjE3NDQ1MjI4MzB9.T_YSsBeIwdvbKBECM79ZHJ5Z3_cCMQeCwMSlF3fHH6g";
  ...
  useEffect(() => {
    ...
    if (isEditMode) {
      ...
      setSelectedChapter(localStorage.getItem("edit_chapter") || "");
  ...
  const addWork = async () => {
    ...
    if (isEditMode && existingRevisionId) {
      const updatePayload = {
        id: parseInt(existingRevisionId),
      ...
      try {
        const editToast = toast.loading('Updating estimate...');
        ...
        toast.success("Estimate updated successfully!", { id: editToast });
